# The name of this view in Looker is "Irish Property Price"
view: irish_property_price {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `daveward-ps-dev.daveward_demodataset.irish_property_price` ;;
